...
不是文档合集，而是一个**每日可交付**的编码训练营。每天产出一个可运行的 Python 脚本，四周完成一个具身视觉数据管道。
...
| Week 4 | Day 22-30 | 进阶+项目 | Day 28 | 特征、视频、数据管道、项目实战 |

## 最终项目

**具身视觉数据管道**：手机拍桌面操作视频 -> 多ROI特征提取 + 帧间追踪 -> JSON/NPZ结构化观察数据。

用到：VideoCapture + 多ROI分析 + 轮廓 + 颜色过滤 + 帧间匹配
...
- progress.md — 学习进度追踪
- docs/30_day_roadmap.md — 30 天路线
- docs/modules/ — 12 个学习模块
- experiments/ — 每日脚本
- data/raw/ — 原始素材
- data/processed/ — 处理结果
- src/utils.py — 可复用工具
